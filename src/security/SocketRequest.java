...
public class SocketRequest {
    ...
    public static void main(String[] args) throws IOException {
        String hostname = "localhost:8084/SgfmApi/login.sv";
        int port = 8084;
        ...
        try {
            ...
            writer.println("SgfmApi/login.sv"); // Important, else the server will expect that there's more into the request.
            writer.println("");
            writer.flush();
